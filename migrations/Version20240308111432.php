 ...
 */
final class Version20240308111432 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, street_name VARCHAR(255) NOT NULL, house_number NUMERIC(5, 2) NOT NULL, zip_code VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, product_id_id INT NOT NULL, customer_id_id INT NOT NULL, size_id_id INT NOT NULL, status VARCHAR(255) NOT NULL, total_price NUMERIC(5, 2) NOT NULL, UNIQUE INDEX UNIQ_F5299398DE18E50B (product_id_id), UNIQUE INDEX UNIQ_F5299398B171EB6C (customer_id_id), UNIQUE INDEX UNIQ_F5299398AE945C60 (size_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, img VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, price NUMERIC(5, 2) NOT NULL, INDEX IDX_D34A04AD12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
